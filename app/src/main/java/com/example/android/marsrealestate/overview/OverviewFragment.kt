...
class OverviewFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.rvMarsProperties.adapter = PhotoGridAdapter(PhotoGridAdapter.PropertyClickListener {
            viewModel.runNavigatingToDetails(it)
        })
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        viewModel.updateProperties(when(item.itemId) {
            R.id.show_buy_menu -> MarsApiFilter.SALE
